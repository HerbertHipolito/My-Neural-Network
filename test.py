...
#x,y = make_classification(n_samples=1000,n_classes=2,n_features=5,random_state=27)
...
print(round(accuracy_score(y_predicted,y_test),3))
...
if graph_options['hist']:
    ...
    for test in range(200):
        ...
        #x2,y2 = make_classification(n_samples=1000,n_classes=2,n_features=5,random_state=27)
